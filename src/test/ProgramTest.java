...
public class ProgramTest {
    ...
    @Test
    public void check_out_a_book() throws IOException {
        System.setOut(new PrintStream(outputStream));
    ...
    @Test
    public void check_out_a_book_that_isnt_available() throws IOException {
        System.setOut(new PrintStream(outputStream));
    ...
    @Test
    public void talk_to_librarian() throws IOException {
        System.setOut(new PrintStream(outputStream));
    ...
    @Test
    public void invalid_entry() throws IOException {
        System.setOut(new PrintStream(outputStream));
    ...
    @Test
    public void show_movie_listing() throws IOException {
        System.setOut(new PrintStream(outputStream));
    ...
    @Test
    public void successfull_log_in() throws IOException {
        System.setOut(new PrintStream(outputStream));
    ...
    @Test
    public void unsuccessful_login_because_of_username() throws IOException {
        System.setOut(new PrintStream(outputStream));
    ...
    @Test
    public void unsuccessful_login_because_of_password() throws IOException {
        System.setOut(new PrintStream(outputStream));
